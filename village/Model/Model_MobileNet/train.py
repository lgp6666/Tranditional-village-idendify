...
from Model.Model_MobileNet.model import create_MobileNet as create_model
...
def train(device, num_classes, train_data_path, val_data_path,
    ...
    with open('CSV\\' + model_name + '_' + str(time_dir) + '_metrics.csv', mode='w', newline='') as file:
        ...
        if fine_tuning:
            ...
            pre_model_path = config['project_path'] + '/Config/pretrained/mobilenet_v3_small_pre.pth'
