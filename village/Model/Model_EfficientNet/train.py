...
from Model.Model_EfficientNet.model import create_efficientnet as create_model
...
def train(device, num_classes, train_data_path, val_data_path,
    ...
    with open('CSV\\' + model_name + '_' + str(time_dir) +  '_metrics.csv', mode='w', newline='') as file:
        ...
        if fine_tuning:
            ...
            pre_model_path = config['project_path'] + '/Config/pretrained/efficientnet_v2_s_pre.pth'
