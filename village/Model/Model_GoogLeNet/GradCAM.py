...
from Model.Model_GoogLeNet.GradCAM_utils import GradCAM, show_cam_on_image
import time
...
def visualize_image(model_weight_path, device, img_path, model_name, show=True):
    ...
    # target_layers = [model.inception5b.branch2[1].conv]
...
if __name__ == '__main__':
    config_model_name = 'Model_GoogLeNet'
    config = load_config()
