...
from Model.Public_Modules.utils_GoogLeNet import train_one_epoch, evaluate
from Model.Model_GoogLeNet.model import create_GoogLeNet as create_model
...
def train(device, num_classes, train_data_path, val_data_path,
    ...
    with open('CSV\\' + model_name + '_' + str(time_dir) + '_metrics.csv', mode='w', newline='') as file:
        ...
        if fine_tuning:
            ...
            pre_model_path = config['project_path'] + '/Config/pretrained/googlenet_pre.pth'
