...
def create_VGG(model_name='VGG16', num_classes=1000):
    if model_name.lower() == 'VGG11'.lower():
        return VGG(make_layers(cfgs['VGG11']), num_classes=num_classes)
    elif model_name.lower() == 'VGG13'.lower():
        return VGG(make_layers(cfgs['VGG13']), num_classes=num_classes)
    elif model_name.lower() == 'VGG16'.lower():
        return VGG(make_layers(cfgs['VGG16']), num_classes=num_classes)
    elif model_name.lower() == 'VGG19'.lower():
